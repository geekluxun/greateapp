 ...
 * under the License.
 */
package com.geekluxun.greateapp.zookeeper.cache;

import com.geekluxun.greateapp.zookeeper.discovery.ExampleServer;
...
public class PathCacheExample {
    ...
    private static final String serverConnectStr = "116.62.63.81:2181";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            client = CuratorFrameworkFactory.newClient(serverConnectStr, new ExponentialBackoffRetry(1000, 3));
            client.start();
