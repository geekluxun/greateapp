 ...
 * under the License.
 */
package com.geekluxun.greateapp.zookeeper.framework;
...
public class CrudExamples {
    private static final String connect = "116.62.63.81:2181";
    private static final String PATH = "/examples/crud";
    ...
    public static void main(String[] argc) throws Exception{
        ...
        createEphemeral(client, PATH, "luxun".getBytes());
        createEphemeralSequential(client, PATH, "luxun".getBytes());
